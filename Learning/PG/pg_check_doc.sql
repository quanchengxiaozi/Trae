...
\o pg_check_report_:current_time.doc

\qecho <!DOCTYPE html>
\qecho <html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w='urn:schemas-microsoft-com:office:word'>
\qecho <head>
\qecho <meta charset="UTF-8">
\qecho <meta name=ProgId content=Word.Document>
\qecho <meta name=Generator content="Microsoft Word 15">
\qecho <meta name=Originator content="Microsoft Word 15">
\qecho <title>PostgreSQL 数据库巡检报告 - :current_time</title>
\qecho <style>
\qecho body { font-family: "Microsoft YaHei", SimSun, Arial, sans-serif; margin: 20px; }
\qecho h1 { color: #336699; font-size: 24pt; }
\qecho h2 { color: #666666; margin-top: 20px; font-size: 16pt; }
\qecho table { border-collapse: collapse; width: 100%; margin: 10px 0; }
\qecho th, td { border: 1px solid #000; padding: 8px; text-align: left; }
\qecho th { background-color: #f5f5f5; }
\qecho tr:nth-child(even) { background-color: #f9f9f9; }
\qecho @page Section1 { margin:2.54cm 3.18cm }
\qecho div.Section1 { page:Section1 }
\qecho </style>
\qecho </head>
\qecho <body>
\qecho <div class="Section1">
